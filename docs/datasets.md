...
<strong>Figure 1:</strong> The TIPMIP Tier 1 Earth system model (ESM) experiment protocol (Jones et al., 2026). ESMs are run in CO<sub>2</sub> emission mode with predicted atmospheric CO<sub>2</sub> concentration and a full carbon cycle.
</figcaption>
</figure>
