...
* CANARI-LE data is available on JASMIN at `/gws/ssde/j25b/canari/shared/large-ensemble/priority`. HIST2 contains the 40 historical ensemble members, 1950-2014, SSP370 the future projection ensemble members, 2015-2100, and HIST1 are the 4 historical ensemble members which were part of CMIP6, 1850-2014.
* Additional data can be retrieved from the JASMIN Elastic Tape.
* More information on the CANARI-LE and the available datasets can be found on the [here](https://ncas-cms.github.io/canari/).
